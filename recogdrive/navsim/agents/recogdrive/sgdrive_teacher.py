...
class FrozenSGDriveTeacher(torch.nn.Module):
    ...
    def __init__(
        ...
        self.sgdrive_teacher_vlm_path = sgdrive_teacher_vlm_path
        self.sgdrive_teacher_vlm_type = sgdrive_teacher_vlm_type
    ...
    def _build_teacher_agent(self):
        ...
        if self.teacher_feature_source == "online":
            ...
            if self.sgdrive_teacher_vlm_path:
                cfg.vlm_path = self.sgdrive_teacher_vlm_path
            if self.sgdrive_teacher_vlm_type:
                cfg.vlm_type = self.sgdrive_teacher_vlm_type
