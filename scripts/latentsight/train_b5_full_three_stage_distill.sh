...
CONFIG=${CONFIG:-${REPO_ROOT}/configs/latentsight/b5_full_three_stage_distill.yaml}
...
WORK_DIR=${WORK_DIR:-${REPO_ROOT}/exp/latentsight_v4/b5_full_three_stage_distill}
...
echo "[LatentSight][Launch] experiment=B5-full-three-stage-distill"
...
torchrun \
  ...
  output_dir="${WORK_DIR}" \
  experiment_name=latentsight_v4_b5_full_three_stage_distill \
