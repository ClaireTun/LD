...
CONFIG=${CONFIG:-${REPO_ROOT}/configs/latentsight/v3/b5_full_three_stage_distill.yaml}
...
WORK_DIR=${WORK_DIR:-${REPO_ROOT}/work_dirs/latentsight_v3/b5_full_three_stage_distill}
...
echo "[LatentSight][Launch] experiment=B5"
echo "[LatentSight][Launch] teacher=true future_queries=true three_stage_distill=true planner_modulation=false"
...
torchrun \
  ...
  output_dir="${WORK_DIR}" \
  experiment_name=latentsight_v3_b5_full_three_stage_distill \
