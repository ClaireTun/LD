...
CONFIG=${CONFIG:-${REPO_ROOT}/configs/latentsight/b3_freeze.yaml}
...
WORK_DIR=${WORK_DIR:-${REPO_ROOT}/exp/latentsight_v4/b3_freeze}
...
echo "[LatentSight][Launch] experiment=B3-freezeViT-vit2llm-projector"
...
torchrun \
  ...
  output_dir="${WORK_DIR}" \
  experiment_name=latentsight_v4_b3_freeze_vit_projector \
