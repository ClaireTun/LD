...
CONFIG=${CONFIG:-${REPO_ROOT}/configs/latentsight/b1_student_low_lr_full_finetune.yaml}
...
WORK_DIR=${WORK_DIR:-${REPO_ROOT}/exp/latentsight_v2/b1_student_low_lr_full_finetune}
...
echo "[LatentSight][Launch] experiment=B1"
